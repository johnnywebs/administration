...
$route['admin/(:any)/(:num)']			= "main_controller/admins/$1";
$route['admin/(:any)']					= "main_controller/admins/$1";
$route['admin/crud/(:any)/(:any)']		= "admin_controller/crud/$1/$2";
$route['admin/prepupdate/(:any)']		= "admin_controller/prep_update/$1";
//Employee Router
