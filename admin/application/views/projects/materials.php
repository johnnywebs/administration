...
<div class="container-fluid">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-12 col-sm-10">
							...
							<h6 class="card-subtitle">List of Materials</h6>
						</div>
						<div class="col-12 col-sm-2">
							<button type='button' data-toggle="modal" data-target="#createMtrlList" class='btn btn-info'><i class='fa fa-edit'></i> Create New</button>
						</div>
					</div>
					<div class="table-responsive m-t-10">
						<table id="tblMtrlList" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th>Description</th>
									<th>Unit</th>
	...
	<!-- start create modal -->
	<div id="createMtrlList" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Create New Materials</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				</div>
				<div class="modal-body">
					<form method="post" action="<?php echo base_url("projects/crud/create/material"); ?>" class="form-horizontal p-t-20">
	...
	<div id="editMtrlList" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Update Materials</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				</div>
				<div class="modal-body">
					<form method="post" action="<?php echo base_url("projects/crud/update/material"); ?>" class="form-horizontal p-t-20">
						<div class="form-group row">
							<label for="description" class="col-sm-12 control-label">Description*</label>
							<div class="col-sm-12">
								<div class="input-group">
...
<script>
	...
	function getMtrl() {
		$.post("<?php echo base_url("projects/crud/retrieve/material"); ?>",{ admin_id : "1" })
		.done(function(data) {
			$("#mtrlListData").html(data);
			$('#tblMtrlList').DataTable({
				dom: 'Bfrtip',
				buttons: [
	...
	function fndeleteMtrl(id) {
		swal({   
            ...
            if (isConfirm) {     
				$.post("<?php echo base_url("projects/crud/delete/material"); ?>",{ admin_id : "1", id: id })
				.done(function(data) {
					if(data == 1) { // or true
						$('#tblMtrlList').DataTable().destroy();
						getMtrl();
