...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php echo base_url('public/assets/images/Geogrout_DSC_0289_1920.jpg'); ?>);">
        <div class="login-box card rounded-0">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" method="get" action="<?php echo base_url("employees/dashboard"); ?>">
                    <a href="javascript:void(0)" class="text-center db"><img src="<?php echo base_url("public/assets/images/logo.png");?>" alt="Home" /></a>
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button onclick="document.location.href='<?php echo base_url("employees/dashboard"); ?>';" class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Log In</button>
                        </div>
                    </div>
                    <div class="row">
